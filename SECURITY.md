...
Please refer to the official Fury [bug bounty program](https://immunefi.com/bounty/fury/)
...
- Use the Fury [bug bounty program](https://immunefi.com/bounty/fury/) on Immunefi to disclose all vulnerabilities,
...
Fury uses the following disclosure process:
...
2. The team determines the vulnerability’s potential impact on Fury.
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Fury in a
    ...
    4. The nodes and validators update their Fury and Ethermint dependencies to use these releases.
    5. A week (or less) after the security vulnerability has been patched on Fury,
...
including but not limited to Fury,
as secure as possible.

### Payment Process

The payment process will be executed according to Fury’s Immunefi Bug Bounty program Rules.

### Contact

The Fury Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@fury.org](mailto:security@fury.org)

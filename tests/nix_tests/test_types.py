...
def test_block(fury, geth):
    ...
    # on fury and geth nodes, and compare the responses
...
def get_blocks(fury_rpc_ws, geth, with_transactions):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
...
def test_accounts(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_syncing(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(fury_rpc_ws, geth):
...
def test_get_code(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(fury_rpc_ws, geth):
    w3: Web3 = fury_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(fury_rpc_ws, geth):
...
def test_incomplete_send_transaction(fury_rpc_ws, geth):

...
// AppName defines the Ledger app used for signing. Fury uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the Fury Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.FuryLedgerDerivation()

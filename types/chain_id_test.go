...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "fury_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid eip155 chain-id, non-integer", "fury_fury_9000-1", true, nil,
		},
		{
		...
		{
			"long chain-id", "fury_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}

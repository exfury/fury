...
wget -O ~/.furyd/config/adrbook.json https://snapshot.notional.ventures/fury/addrbook.json
...
export FURYD_P2P_MAX_NUM_INBOUND_PEERS=200
export FURYD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export FURYD_STATESYNC_RPC_SERVERS="https://fury-rpc.polkachu.com:443,https://rpc-fury-ia.notional.ventures:443"

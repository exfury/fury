...
// source: fury/claims/v1/claims.proto
...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_74b385566006b40a, []int{0}
}
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=fury.claims.v1.Action" json:"action,omitempty"`
...
func (*ClaimsRecordAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_74b385566006b40a, []int{1}
}
...
func (*ClaimsRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_74b385566006b40a, []int{2}
}
...
func init() {
	proto.RegisterEnum("fury.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "fury.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "fury.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "fury.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("fury/claims/v1/claims.proto", fileDescriptor_74b385566006b40a) }

var fileDescriptor_74b385566006b40a = []byte{
	// 513 bytes of a gzipped FileDescriptorProto
	,
}

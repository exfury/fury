...
import (
	...
	"github.com/exfury/fury/v15/x/ibc/transfer/keeper"
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				...
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("afury", sdk.NewInt(10)), senderAcc.String(), "", timeoutHeight, 0, "")

				coins := sdk.NewCoins(sdk.NewCoin("afury", sdk.NewInt(10)))

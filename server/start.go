...
import (
	...
	"github.com/exfury/fury/v15/cmd/furyd/opendb"
	"github.com/exfury/fury/v15/indexer"
	ethdebug "github.com/exfury/fury/v15/rpc/namespaces/ethereum/debug"
...
`,
	...
	cmd.Flags().String(server.FlagMinGasPrices, "", "Minimum gas prices to accept for transactions; Any fee in a tx must meet this minimum (e.g. 20000000000afury)") //nolint:lll
...
func startInProcess(ctx *server.Context, clientCtx client.Context, opts StartOptions) (err error) {
	...
	var idxer furytypes.EVMTxIndexer

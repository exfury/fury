...
import (
	...
	cmdcfg "github.com/exfury/fury/v15/cmd/config"
	furykr "github.com/exfury/fury/v15/crypto/keyring"
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = fmt.Sprintf("fury_%d-1", tmrand.Int63n(9999999999999)+1)
	}
	...
	for i := 0; i < args.numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), args.keyringBackend, nodeDir, inBuf, clientCtx.Codec, furykr.Option())
		if err != nil {
			return err
		}

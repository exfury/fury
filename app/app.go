...
import (
	...
	_ "github.com/exfury/fury/v15/client/docs/statik"

	"github.com/exfury/fury/v15/app/ante"
	ethante "github.com/exfury/fury/v15/app/ante/evm"
	v10 "github.com/exfury/fury/v15/app/upgrades/v10"
	v11 "github.com/exfury/fury/v15/app/upgrades/v11"
	v12 "github.com/exfury/fury/v15/app/upgrades/v12"
	v13 "github.com/exfury/fury/v15/app/upgrades/v13"
	v14 "github.com/exfury/fury/v15/app/upgrades/v14"
	v15 "github.com/exfury/fury/v15/app/upgrades/v15"
	v8 "github.com/exfury/fury/v15/app/upgrades/v8"
	v81 "github.com/exfury/fury/v15/app/upgrades/v8_1"
	v82 "github.com/exfury/fury/v15/app/upgrades/v8_2"
	v9 "github.com/exfury/fury/v15/app/upgrades/v9"
	v91 "github.com/exfury/fury/v15/app/upgrades/v9_1"
	"github.com/exfury/fury/v15/encoding"
	"github.com/exfury/fury/v15/ethereum/eip712"
	"github.com/exfury/fury/v15/precompiles/common"
	srvflags "github.com/exfury/fury/v15/server/flags"
	furytypes "github.com/exfury/fury/v15/types"
	"github.com/exfury/fury/v15/x/claims"
	claimskeeper "github.com/exfury/fury/v15/x/claims/keeper"
	claimstypes "github.com/exfury/fury/v15/x/claims/types"
	"github.com/exfury/fury/v15/x/epochs"
	epochskeeper "github.com/exfury/fury/v15/x/epochs/keeper"
	epochstypes "github.com/exfury/fury/v15/x/epochs/types"
	"github.com/exfury/fury/v15/x/erc20"
	erc20client "github.com/exfury/fury/v15/x/erc20/client"
	erc20keeper "github.com/exfury/fury/v15/x/erc20/keeper"
	erc20types "github.com/exfury/fury/v15/x/erc20/types"
	"github.com/exfury/fury/v15/x/evm"
	evmkeeper "github.com/exfury/fury/v15/x/evm/keeper"
	evmtypes "github.com/exfury/fury/v15/x/evm/types"
	"github.com/exfury/fury/v15/x/feemarket"
	feemarketkeeper "github.com/exfury/fury/v15/x/feemarket/keeper"
	feemarkettypes "github.com/exfury/fury/v15/x/feemarket/types"
	"github.com/exfury/fury/v15/x/incentives"
	incentivesclient "github.com/exfury/fury/v15/x/incentives/client"
	incentiveskeeper "github.com/exfury/fury/v15/x/incentives/keeper"
	incentivestypes "github.com/exfury/fury/v15/x/incentives/types"
	"github.com/exfury/fury/v15/x/inflation"
	inflationkeeper "github.com/exfury/fury/v15/x/inflation/keeper"
	inflationtypes "github.com/exfury/fury/v15/x/inflation/types"
	"github.com/exfury/fury/v15/x/recovery"
	recoverykeeper "github.com/exfury/fury/v15/x/recovery/keeper"
	recoverytypes "github.com/exfury/fury/v15/x/recovery/types"
	revenue "github.com/exfury/fury/v15/x/revenue/v1"
	revenuekeeper "github.com/exfury/fury/v15/x/revenue/v1/keeper"
	revenuetypes "github.com/exfury/fury/v15/x/revenue/v1/types"
	"github.com/exfury/fury/v15/x/vesting"
	vestingclient "github.com/exfury/fury/v15/x/vesting/client"
	...
	"github.com/exfury/fury/v15/x/ibc/transfer"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".furyd")

	// manually update the power reduction by replacing micro (u) -> atto (a) fury
	sdk.DefaultPowerReduction = furytypes.PowerReduction
...
func (*Fury) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}
...
func NewFury(
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		furytypes.ProtoAccount, maccPerms,
...
func (app *Fury) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: furytypes.HasDynamicFeeExtensionOption,
...
func (app *Fury) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Fury) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Fury) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *Fury) RegisterNodeService(clientCtx client.Context) {
...
func (app *Fury) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Fury) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

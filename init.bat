...
furyd keys add %KEY% --keyring-backend %KEYRING% --algo %KEYALGO%
...
furyd add-genesis-account %KEY% 100000000000000000000000000afury --keyring-backend %KEYRING%

rem Sign genesis transaction
furyd gentx %KEY% 1000000000000000000000afury --keyring-backend %KEYRING% --chain-id %CHAINID%
...
furyd start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001afury